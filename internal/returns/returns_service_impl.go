...
func (s *Service) VoidSale(ctx context.Context, id uuid.UUID, in VoidSaleRequest) (*Void, error) {
...
func (s *Service) CreateReturn(ctx context.Context, in CreateReturnRequest) (*Return, error) {
...
func (s *Service) CreateExchange(ctx context.Context, in CreateExchangeRequest) (*Exchange, error) {
